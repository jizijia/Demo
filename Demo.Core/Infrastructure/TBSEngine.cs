...
namespace Demo.Core.Infrastructure
{
    ...
    public class AppEngine : IEngine
    {
        ...
        protected virtual void RegisterDependencies(SysConfig config)
        {
            ...
            builder.RegisterInstance(config).As<SysConfig>().SingleInstance();
        ...
        /// </summary>
        /// <param name="config">Config</param>
        public void Initialize(SysConfig config)
        {
            //register dependencies
